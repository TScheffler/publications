...
\begin{enumerate}
  ...
  \item \textbf{Sloppiness of users' input}. In the scope of this
    group, we considered incorrect spellings of words encountered in
    text.\label{spell}
\end{enumerate}
...
colloquial spelling variants. Such variants accounted for 70.5~\% of
detected spelling mistakes in \texttt{hunspell} data and for 66.17~\%
of misspellings recognized by \texttt{TreeTagger}. Frequency
...
by systematic rewriting processes which are also usually applied to
...
In order to investigate which processes were the most common sources
of colloquial spellings

These processes are supposed to make written form of words more
similar to their casual soundings in everyday speech.

According to our data, the most productive of such
processes were:
\begin{itemize}
